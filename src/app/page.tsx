...
const features = [
  {
    ...
    description: "Founders: Sculpt stunning profiles, share compelling ideas, and captivate the right audience with AI-powered tools.",
  ...
  },
  {
    ...
    description: "Track your startup's evolution from spark to scale. Leverage AI insights to refine your pitch and strategy.",
    link: "/founder-dashboard", 
    linkText: "Visualize Your Milestones"
  },
  {
    icon: <MessageSquare className="h-10 w-10 text-primary mb-4" />,
    title: "Narrato AI Insights",
    description: "Our intelligent assistant, Narrato, delivers tailored suggestions, guiding you effortlessly through PitchPerfect.",
    link: "#chatbot", 
...
export default function HomePage() {
  return (
    <div className="flex flex-col items-center">
      {/* Hero Section */}
      <section className="w-full py-20 md:py-32 text-center bg-transparent animate-fade-in-up">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
            Where visionary founders meet insightful investors. PitchPerfect is your launchpad to success, amplified by AI. Let's craft the future, together.
          </p>
      ...
      <section id="features" className="w-full py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold font-headline text-center mb-4">Why Choose PitchPerfect?</h2>
          <p className="text-center text-muted-foreground mb-12 max-w-xl mx-auto">Empowering innovation with AI-driven tools for groundbreaking success stories.</p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="text-center shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:scale-105 animate-fade-in-up bg-card/80 backdrop-blur-sm" style={{animationDelay: `${index * 100}ms`}}>
                <CardHeader>
      ...
      <section className="w-full py-16 md:py-24 bg-secondary/30 dark:bg-secondary/10 backdrop-blur-sm">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold font-headline text-center mb-12">Your Journey to Impact, Simplified</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
            <div className="flex flex-col items-center animate-fade-in-up" style={{animationDelay: `600ms`}}>
              ...
              <p className="text-muted-foreground">Select your path. Founders shape profiles & spark ideas; Investors set focus.</p>
            </div>
            <div className="flex flex-col items-center animate-fade-in-up" style={{animationDelay: `700ms`}}>
              ...
              <p className="text-muted-foreground">Founders present AI-enhanced innovations; Investors explore opportunities.</p>
            </div>
            <div className="flex flex-col items-center animate-fade-in-up" style={{animationDelay: `800ms`}}>
              ...
              <p className="text-muted-foreground">Forge partnerships. Ignite discussions. Accelerate growth with confidence.</p>
            </div>
          </div>
        </div>
      </section>
