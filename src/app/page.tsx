    ...
    <div className="flex flex-col items-center">
      ...
      <section className="w-full py-20 md:py-32 text-center bg-transparent animate-fade-in-up">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
            Where visionary founders meet insightful investors. PitchPerfect is your launchpad to success. Let's craft the future, together.
          </p>
      ...
      <section id="features" className="w-full py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-muted-foreground mb-12 max-w-xl mx-auto">Empowering innovation with precision tools for unprecedented success stories.</p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
            <div className="flex flex-col items-center animate-fade-in-up" style={{animationDelay: `600ms`}}>
              ...
              <p className="text-muted-foreground">Select your path. Founders shape profiles; Investors set focus.</p>
            </div>
            <div className="flex flex-col items-center animate-fade-in-up" style={{animationDelay: `700ms`}}>
              ...
              <p className="text-muted-foreground">Founders present innovations; Investors explore opportunities.</p>
            </div>
            <div className="flex flex-col items-center animate-fade-in-up" style={{animationDelay: `800ms`}}>
              ...
              <p className="text-muted-foreground">Forge partnerships. Ignite discussions. Accelerate growth.</p>
            </div>
          </div>
        </div>
      </section>
